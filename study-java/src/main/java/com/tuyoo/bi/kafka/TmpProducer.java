...
public class TmpProducer {
    ...
    public static void main(String[] args) throws InterruptedException {
        TmpProducer tmpProducer = new TmpProducer();
    ...
    public JSONObject getPropertiesEvent1_05() {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("sdk_s_login_type", "dev");
        jsonObject.put("sdk_yidun_device_check_simulator", "0");
        jsonObject.put("sdk_yidun_device_type", "Android");
        jsonObject.put("test_property1", "blahblah");
        jsonObject.put("test_property3", "11");
        jsonObject.put("android_id", "sdfasgasgdfd");

        return jsonObject;
    }

    public JSONObject getPropertiesEvent1_061() {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("sdk_s_login_type", "dev");
        jsonObject.put("sdk_yidun_device_check_simulator", "0");
        jsonObject.put("sdk_yidun_device_type", "Android");
        jsonObject.put("test_property1", "blahblah");
        jsonObject.put("test_property3", "ttttt");
        jsonObject.put("android_id", "sdfasgasgdfd");

        return jsonObject;
    }

    public JSONObject getPropertiesEvent1_062() {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("sdk_s_login_type", "dev");
        jsonObject.put("sdk_yidun_device_check_simulator", "0");
        jsonObject.put("sdk_yidun_device_type", "Android");
    ...
    public JSONObject getPropertiesEvent1_063() {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("sdk_s_login_type", "dev");
        jsonObject.put("sdk_yidun_device_check_simulator", "0");
        jsonObject.put("test_property1", "blahblah");
        jsonObject.put("test_property3", "-99999");
        jsonObject.put("android_id", "sdfasgasgdfd");
